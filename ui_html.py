...
<body>
    ...
    <div class="modal-overlay" id="loginModal">
        <div class="modal">
            ...
            <input type="text" id="loginCode" placeholder="Verification code (for signup)" />
            <div class="modal-actions">
                <button class="secondary" id="closeLogin">Cancel</button>
                <button class="primary" id="loginBtn">Login</button>
            </div>
            <div class="modal-actions">
                <button class="secondary" id="sendCodeBtn">Send Code</button>
        ...
        if (signupBtn) {
            signupBtn.addEventListener('click', async () => {
                try {
                    ...
                    setAuth(data.token, data.email);
                    hideLoginModal();
                    showTinyToast("Your account was created successfully. Enjoy this AI!");
                } catch (error) {
        ...
        if (sendCodeBtn) {
            sendCodeBtn.addEventListener('click', async () => {
                try {
                    ...
                    showTinyToast("Verification code sent to your email.");
                } catch (error) {
                    showLoginModal(error.message || "Failed to send code.");
                }
            });
        }
